#!/usr/bin/env python3
"""Grade the script outputs - Iteration 5."""
    ...
    for assertion in eval_metadata["assertions"]:
        ...
        if name == "包含批量热点分析报告":
            ...
            if 4 <= shot_count <= 8:
                ...
                if time_markers:
                    total_time = sum(int(t) for t in time_markers[:3])
...
def main():
    base_path = "/Users/Abner/.claude/skills/hot-script-generator/workspace/iteration-5/batch-hotspots"
